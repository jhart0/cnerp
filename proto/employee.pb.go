...
func (x *ManagerReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ManagerReply) ProtoMessage() {}

func (x *ManagerReply) ProtoReflect() protoreflect.Message {
	mi := &file_employee_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ManagerReply.ProtoReflect.Descriptor instead.
func (*ManagerReply) Descriptor() ([]byte, []int) {
	return file_employee_proto_rawDescGZIP(), []int{1}
}

func (x *ManagerReply) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_employee_proto_rawDesc = []byte{
	...
	,
...
var file_employee_proto_goTypes = []interface{}{
	(*ManagerRequest)(nil), // 0: employee.ManagerRequest
	(*ManagerReply)(nil),   // 1: employee.ManagerReply
}
var file_employee_proto_depIdxs = []int32{
	0, // 0: employee.Employee.GetManager:input_type -> employee.ManagerRequest
	1, // 1: employee.Employee.GetManager:output_type -> employee.ManagerReply
